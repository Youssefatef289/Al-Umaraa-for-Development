  ...
  return (
    <>
      ...
      <a
        ...
        className="group fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_34px_-8px_rgba(37,211,102,0.7)] transition-all duration-300 hover:-translate-y-1 hover:bg-[#20bd5a] sm:bottom-7 sm:right-7 sm:h-16 sm:w-16"
      >
        ...
        <span className="pointer-events-none absolute left-full ml-3 hidden whitespace-nowrap rounded-lg bg-ink-card px-3 py-2 text-xs font-bold text-navy opacity-0 shadow-luxe transition-opacity duration-300 group-hover:opacity-100 sm:block">
          تواصل معنا الآن
        </span>
      </a>
    </>
