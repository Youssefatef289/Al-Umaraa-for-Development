export const site = {
  ...
  hero: {
    badge: "شركة الأمراء للاستثمار والتطوير العقاري",
    title: "نصنع مجتمعات سكنية",
    subtitle: "تعيد تعريف الحياة العصرية",
    titleVariants: [
      "نصنع مجتمعات سكنية",
      "نبني أحلامك العقارية",
      "نطوّر مشاريع متميزة",
    ],
    subtitleVariants: [
      "تعيد تعريف الحياة العصرية",
      "بثقة وجودة في بني سويف",
      "شريكك في كل خطوة",
    ],
    description:
      "شريكك الموثوق في تطوير الأبراج والفلل السكنية — نجمع بين التصميم العصري وأعلى معايير الجودة لنقدّم لك وحدتك المثالية في بني سويف.",
